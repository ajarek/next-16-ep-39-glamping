      ...
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='text-center max-w-2xl mx-auto mb-12'>
          ...
          <p className='mt-4 text-sm text-fg-custom/60 font-light leading-relaxed'>
            Kliknij pinezkę na naszej topograficznej mapie, aby zlokalizować
            obiekt, sprawdzić warunki i przejść do szczegółów.
          </p>
        </div>

        {/* Mapa SVG + Pinezki z nakładkami */}
        <div className='relative aspect-video w-full max-w-5xl mx-auto rounded-3xl border border-border-custom bg-card-custom overflow-hidden shadow-xl'>
          ...
          >
            ...
            <polygon
              points='700,450 780,330 860,450'
              fill='currentColor'
              opacity='0.3'
            />
            <polygon
              points='750,450 810,360 870,450'
              fill='currentColor'
              opacity='0.4'
            />
            <polygon
              points='200,350 250,270 300,350'
              fill='currentColor'
              opacity='0.3'
            />
            <polygon
              points='240,350 280,290 320,350'
              fill='currentColor'
              opacity='0.4'
            />
                ...
                >
                  ...
                  <span
                    className={`absolute inline-flex h-10 w-10 rounded-full opacity-40 animate-ping ${
                      isActive ? "bg-brand-accent" : "bg-brand-primary"
                    }`}
                  />
                  ...
                  {(isHovered || isActive) && (
                    ...
                    >
                      ...
                      <div className='mt-2.5 text-left'>
                        <h4 className='text-xs font-bold text-fg-custom truncate'>
                          {loc.name}
                        </h4>
