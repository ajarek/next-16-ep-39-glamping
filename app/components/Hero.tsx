...
const SLIDES = [
  {
    ...
    subtitle: "Ręcznie wybrane miejsca, gdzie piękno natury łączy się ze zrównoważonym komfortem.",
  },
  {
    image: "/images/lakeside-retreat.png",
    title: "Obudź się\nnad brzegiem jeziora",
    subtitle: "Doświadcz luksusu pośród szczytów górskich i krystalicznie czystej wody.",
  },
  {
    image: "/images/meadow-vista.png",
    title: "Zasypiaj pod\ngwiaździstym niebem",
    subtitle: "Odkryj kopuły geodezyjne z panoramicznym widokiem na drogę mleczną.",
  },
];
