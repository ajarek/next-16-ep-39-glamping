...
export default function AboutPage() {
  return (
    <div className='min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(45,62,44,0.16),transparent_25%),radial-gradient(circle_at_bottom_right,rgba(200,149,98,0.18),transparent_28%)]'>
      <section className='mx-auto flex max-w-7xl flex-col gap-10 px-6 py-12 md:px-8 lg:px-10 lg:py-16'>
        <div className='grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center'>
          <div className='space-y-6'>
            <div className='inline-flex items-center gap-2 rounded-full border border-brand-accent/30 bg-brand-accent/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.35em] text-brand-accent'>
              <Compass className='h-3.5 w-3.5' />O nas
            </div>
            ...
            <div className='space-y-4'>
              ...
              <p className='max-w-2xl text-base leading-8 text-fg-custom/70 sm:text-lg'>
                Wild Haven to przestrzeń dla osób, które szukają chwili
                wytchnienia bez rezygnacji z komfortu. Łączymy dziką naturę,
                estetykę i ciepło domowego wypoczynku w jedno niezapomniane
                doświadczenie.
              </p>
            </div>
          ...
          <div className='rounded-4xl border border-border-custom bg-card-custom/80 p-8 shadow-[0_25px_80px_-35px_rgba(0,0,0,0.35)] backdrop-blur-xl'>
            ...
            <div className='mt-6 space-y-4 text-sm leading-7 text-fg-custom/70'>
              <p>
                Każde miejsce w naszej ofercie zostało stworzone z myślą o
                osobach, które cenią spokój, piękno i autentyczność. Nie szukamy
                tylko luksusu – szukamy głębi i harmonii.
              </p>
              <p>
        ...
        <div className='rounded-4xl border border-border-custom bg-card-custom/80 p-8 shadow-[0_25px_80px_-40px_rgba(0,0,0,0.35)] backdrop-blur-xl'>
          <div className='grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center'>
            <div>
              ...
              <h3 className='mt-2 text-3xl font-semibold text-fg-custom'>
                Wierzymy, że najlepszy wypoczynek zaczyna się od dobrej energii
                miejsca.
              </h3>
            </div>
            <div className='rounded-3xl border border-border-custom bg-background/70 p-6 text-sm leading-8 text-fg-custom/70'>
              <p>
