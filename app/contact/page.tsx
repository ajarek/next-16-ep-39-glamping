...
export default function ContactPage() {
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(200,149,98,0.16),_transparent_28%),radial-gradient(circle_at_bottom_right,_rgba(45,62,44,0.16),_transparent_30%)]">
      <section className="mx-auto flex max-w-7xl flex-col gap-10 px-6 py-12 md:px-8 lg:px-10 lg:py-16">
        <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="max-w-2xl text-base leading-8 text-fg-custom/70 sm:text-lg">
                Niezależnie od tego, czy planujesz romantyczny weekend,
                rodzinowy wypoczynek czy wyjątkową celebrację, nasz zespół
                przygotuje dla Ciebie idealne miejsce wśród natury.
              </p>
            </div>
          ...
          <div className="rounded-[2rem] border border-border-custom bg-card-custom/80 p-6 shadow-[0_25px_80px_-35px_rgba(0,0,0,0.35)] backdrop-blur-xl">
        ...
        <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="rounded-[2rem] border border-border-custom bg-card-custom/80 p-6 shadow-[0_25px_70px_-40px_rgba(0,0,0,0.35)] backdrop-blur-xl">
            <div className="flex items-center gap-3">
            ...
            <ul className="mt-6 space-y-4 text-sm leading-7 text-fg-custom/70">
              <li className="rounded-2xl border border-border-custom/70 bg-background/60 p-4">
                <span className="font-semibold text-fg-custom">Rezerwacje grupowe:</span>{" "}
                ślubów, urodzin i spotkań firmowych.
              </li>
              <li className="rounded-2xl border border-border-custom/70 bg-background/60 p-4">
                <span className="font-semibold text-fg-custom">Dodatkowe usługi:</span>{" "}
                śniadania, transfery i aranżacja przestrzeni.
              </li>
              <li className="rounded-2xl border border-border-custom/70 bg-background/60 p-4">
                <span className="font-semibold text-fg-custom">Elastyczne terminy:</span>{" "}
