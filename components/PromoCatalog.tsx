...
export default function PromoCatalog({
  ...
  return (
    <section
      id='promo-locations'
      className='py-24 px-6 bg-background transition-colors'
    >
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='flex flex-col md:flex-row md:items-end justify-between gap-6 pb-10 border-b border-border-custom'>
          ...
          <p className='text-sm text-fg-custom/60 max-w-md font-light leading-relaxed'>
            Prezentujemy wybrane kempingi z naszej oferty. Każdy z nich łączy
            dziką naturę z bezkompromisowym komfortem. Zobacz naszą pełną
            ofertę, aby znaleźć idealne miejsce na kolejną przygodę.
          </p>
        </div>
            ...
            >
              ...
              <div className='p-6 flex flex-col justify-between flex-1'>
                ...
                <div className='border-t border-border-custom mt-6 pt-6 flex items-center justify-between'>
                  <div>
                    <span className='text-2xl font-black text-fg-custom'>
                      PLN {loc.price}
                    </span>
        ...
        <div className='mt-16 flex justify-center'>
          <Link
            href='/locations'
            className='group relative inline-flex items-center gap-3 px-8 py-4 bg-brand-primary text-brand-primary-fg font-bold tracking-wider text-xs rounded-full overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300'
          >
